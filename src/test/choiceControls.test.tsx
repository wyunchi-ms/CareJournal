...
describe('unified choice controls', () => {
  ...
  it('uses the same picker for single and multiple selections', () => {
    ...
    const dialog = screen.getByRole('dialog', { name: '检查类型（可多选）' })
    const scroll = dialog.querySelector<HTMLElement>('.choice-option-scroll')
    const footer = dialog.querySelector<HTMLElement>('.choice-picker-footer')
