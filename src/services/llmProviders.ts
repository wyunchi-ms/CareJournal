...
export const LLM_PROVIDERS: LlmProviderDefinition[] = [
  ...
  },
  {
    id: 'kimi',
    label: '月之暗面 Kimi',
    description: '月之暗面官方 OpenAI 兼容 API',
  ...
  },
  {
    ...
    modelPlaceholder: '填写模型广场中的模型 ID',
    responseFormat: 'prompt',
    tokenParameter: 'max_tokens',
  },
  {
    id: 'tencent-hunyuan',
    label: '腾讯混元',
    description: '腾讯云混元 OpenAI 兼容接口',
    defaultEndpoint: 'https://api.hunyuan.cloud.tencent.com/v1',
    endpointPlaceholder: 'https://api.hunyuan.cloud.tencent.com/v1',
  ...
  },
  {
    id: 'stepfun',
    label: '阶跃星辰',
    description: 'StepFun 开放平台兼容接口',
    defaultEndpoint: 'https://api.stepfun.com/v1',
    endpointPlaceholder: 'https://api.stepfun.com/v1',
    modelPlaceholder: '例如 step-3.5-flash',
    responseFormat: 'prompt',
    tokenParameter: 'max_tokens',
  },
  {
    id: 'baichuan',
    label: '百川智能',
    description: '百川大模型官方 API',
    defaultEndpoint: 'https://api.baichuan-ai.com/v1',
    endpointPlaceholder: 'https://api.baichuan-ai.com/v1',
    modelPlaceholder: '填写开放平台中的模型名称',
    responseFormat: 'prompt',
    tokenParameter: 'max_tokens',
  },
  {
    id: 'iflytek-spark',
    label: '讯飞星火',
    description: '讯飞开放平台 OpenAI 兼容接口',
    defaultEndpoint: 'https://spark-api-open.xf-yun.com/v1',
    endpointPlaceholder: 'https://spark-api-open.xf-yun.com/v1',
    modelPlaceholder: '例如 generalv3.5',
    responseFormat: 'prompt',
    tokenParameter: 'max_tokens',
  },
  {
  ...
  },
  {
    id: 'glm',
    label: '智谱 GLM',
    description: '智谱 AI 官方 OpenAI 兼容 API',
    defaultEndpoint: 'https://open.bigmodel.cn/api/paas/v4',
    endpointPlaceholder: 'https://open.bigmodel.cn/api/paas/v4',
    modelPlaceholder: '例如 glm-5.2 或视觉模型 ID',
    responseFormat: 'json-object',
    tokenParameter: 'max_tokens',
  },
  {
